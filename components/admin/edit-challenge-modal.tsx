...
export default function EditChallengeModal({ challenge, onClose, onSubmit }: EditChallengeModalProps) {
  const [formData, setFormData] = useState({
    ...
    dailyPrompts: challenge.dailyPrompts.length > 0 ? challenge.dailyPrompts : [""],
  })
    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="glass-card rounded-3xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto animate-slide-up">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold gradient-text">Edit Challenge</h2>
          <button
            onClick={onClose}
