...
export default function MemberLoginPage({ onSwitchToSignup, onLoginSuccess }: MemberLoginPageProps) {
  const { login } = useAuth()
        ...
        <div className="glass-card rounded-3xl p-8 animate-slide-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <button
                type="button"
                className="text-brand-green hover:text-brand-orange transition-colors text-sm font-medium"
              >
