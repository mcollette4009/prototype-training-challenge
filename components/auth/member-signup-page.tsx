...
export default function MemberSignUpPage({ onSwitchToLogin, onSignupSuccess }: MemberSignUpPageProps) {
      ...
      <div className="w-full max-w-mobile">
        <div className="glass-card rounded-3xl p-8 animate-slide-up">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold gradient-text mb-2">Join the Challenge</h1>
            <p className="text-gray-300">Create your account to start transforming</p>
          </div>
